...
describe 'GridCoordinate' do
  describe ".get_top_left_neighbour" do
    context "cell is at [1,1]" do
      underTest = GridCoordinate.new(1, 1)
      it "returns [0,0]" do
        result = underTest.get_top_left_neighbour
  ...
  describe ".get_top_neighbour" do
    context "cell is at [1,1]" do
      underTest = GridCoordinate.new(1, 1)
      it "returns [0,1]" do
        result = underTest.get_top_neighbour
  ...
  describe ".get_top_right_neighbour" do
    context "cell is at [1,1]" do
      underTest = GridCoordinate.new(1, 1)
      it "returns [0,2]" do
        result = underTest.get_top_right_neighbour
  ...
  describe ".get_left_neighbour" do
    context "cell is at [1,1]" do
      underTest = GridCoordinate.new(1, 1)
      it "returns [1,0]" do
        result = underTest.get_left_neighbour
  ...
  describe ".get_right_neighbour" do
    context "cell is at [1,1]" do
      underTest = GridCoordinate.new(1, 1)
      it "returns [1,2]" do
        result = underTest.get_right_neighbour
  ...
  describe ".get_bottom_left_neighbour" do
    context "cell is at [1,1]" do
      underTest = GridCoordinate.new(1, 1)
      it "returns [2,0]" do
        result = underTest.get_bottom_left_neighbour
  ...
  describe ".get_bottom_neighbour" do
    context "cell is at [1,1]" do
      underTest = GridCoordinate.new(1, 1)
      it "returns [2,1]" do
        result = underTest.get_bottom_neighbour
  ...
  describe ".get_bottom_right_neighbour" do
    context "cell is at [1,1]" do
      underTest = GridCoordinate.new(1, 1)
      it "returns [2,2]" do
        result = underTest.get_bottom_right_neighbour
