...
require_relative 'domain/grid_factory'
require_relative 'services/cell_proximity_service'
require_relative 'services/grid_printer_service'
require_relative 'services/grid_seeder_service'
require_relative 'services/cell_survival_service'
...
game = GameEngine.new(grid,
                      cell_proximity_service,
                      grid_printer_service,
                      grid_seeder_service,
                      cell_survival_service)
